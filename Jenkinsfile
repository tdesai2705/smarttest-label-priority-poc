...
//
// This branch targets a brand-new, dedicated Smart Tests workspace (PTS v2)
...
PYEOF
    ...
    post {
        success {
            echo "Pipeline done | Build: ${BUILD_NUMBER} | Workspace: PTS v2 (61b40965-5197-4ba2-ab22-dfbaa2361d69)"
        }
    }
}
